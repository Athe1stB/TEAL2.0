...
class CreateCourseForm extends moodleform
{
    ...
    public function definition()
    {
        ...
        $course_name_element = $form->addElement('autocomplete', 'name', "Course Name", $course_array, $options, array('autocomplete' => 'false'));
        $course_name_element->setValue("");

        // Repo name
        $form->addElement('hidden', 'repo_name', '');

        // Import check flag
        $form->addElement('hidden', 'is_imported', 'no');

        // Branch selection
        $form->addElement('select', 'branch', 'Institute(Branch)', ["" => "Select Branch"]);
        $form->addElement('hidden', 'branch_hid', '');

        // Commit selection
        $form->addElement('select', 'commit', 'Version(Commit)', ["" => "Select Version"]);
        $form->addElement('hidden', 'commit_hid', '');

        // Course Objective
        $form->addElement('text', 'objective', 'Objective');
        ...
        $form->addElement('select', 'level', 'Level', $course_levels_map);
